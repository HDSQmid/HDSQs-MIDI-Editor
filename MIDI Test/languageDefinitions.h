...
//default
#define CONSOLE_INPUT_HANDLER_DEFAULT_IDENTIFIER (100011)
...
//file open
#define CONSOLE_INPUT_HANDLER_FILE_OPEN_IDENTIFIER (100021)
...
//file close
#define CONSOLE_INPUT_HANDLER_FILE_CLOSE_IDENTIFIER (100031)
...
//file save
#define CONSOLE_INPUT_HANDLER_FILE_SAVE_IDENTIFIER (100041)
...
//file save as
#define CONSOLE_INPUT_HANDLER_FILE_SAVE_AS_IDENTIFIER (100051)
#define CONSOLE_INPUT_HANDLER_FILE_SAVE_AS_DESCRIPTION (100052)
#define CONSOLE_INPUT_HANDLER_FILE_SAVE_AS_ARGUMENTS (100053)
#define CONSOLE_INPUT_HANDLER_FILE_SAVE_AS_EXAMPLE_USAGE (100043)

//quit application
#define CONSOLE_INPUT_HANDLER_QUIT_IDENTIFIER (100061)
#define CONSOLE_INPUT_HANDLER_QUIT_DESCRIPTION (100062)
#define CONSOLE_INPUT_HANDLER_QUIT_ARGUMENTS (100063)
#define CONSOLE_INPUT_HANDLER_QUIT_EXAMPLE_USAGE (100063)

//help
#define CONSOLE_INPUT_HANDLER_HELP_IDENTIFIER (100071)
#define CONSOLE_INPUT_HANDLER_HELP_DESCRIPTION (100072)
#define CONSOLE_INPUT_HANDLER_HELP_ARGUMENTS (100073)
#define CONSOLE_INPUT_HANDLER_HELP_EXAMPLE_USAGE (100073)

//crash
#define CONSOLE_INPUT_HANDLER_CRASH_IDENTIFIER (100081)
#define CONSOLE_INPUT_HANDLER_CRASH_DESCRIPTION (100082)
#define CONSOLE_INPUT_HANDLER_CRASH_ARGUMENTS (100083)
#define CONSOLE_INPUT_HANDLER_CRASH_EXAMPLE_USAGE (100083)

//info
#define CONSOLE_INPUT_HANDLER_INFO_IDENTIFIER (100091)
#define CONSOLE_INPUT_HANDLER_INFO_DESCRIPTION (100092)
#define CONSOLE_INPUT_HANDLER_INFO_ARGUMENTS (100093)
#define CONSOLE_INPUT_HANDLER_INFO_EXAMPLE_USAGE (100093)

//new file
#define CONSOLE_INPUT_HANDLER_FILE_NEW_IDENTIFIER (100101)
#define CONSOLE_INPUT_HANDLER_FILE_NEW_DESCRIPTION (100102)
#define CONSOLE_INPUT_HANDLER_FILE_NEW_ARGUMENTS (100103)
#define CONSOLE_INPUT_HANDLER_FILE_NEW_EXAMPLE_USAGE (100103)

//new file
#define CONSOLE_INPUT_HANDLER_MAKE_EDIT_IDENTIFIER (100111)
#define CONSOLE_INPUT_HANDLER_MAKE_EDIT_DESCRIPTION (100112)
#define CONSOLE_INPUT_HANDLER_MAKE_EDIT_ARGUMENTS (100113)
#define CONSOLE_INPUT_HANDLER_MAKE_EDIT_EXAMPLE_USAGE (100113)
